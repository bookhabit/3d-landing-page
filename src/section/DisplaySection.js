...
const DisplaySection = () => {
    ...
    useLayoutEffect(()=>{
        ...
        t1.fromTo(textOne.current,{x:0},{x:"-20%"},"key1").fromTo(textTwo.current,{x:0},{x:"20%"},"key1")
  ...
  return (
    <Section>
      ...
      <TextBlockRight>
        <Title>Supper Ratine XDR Display</Title>
        <Text>
      ...
      <TextContainer>
        <MovingText ref={textOne}>Tougher the ever!</MovingText>
